...
export type GetBoardQuery = { __typename?: 'query_root', boards_by_pk?: { __typename?: 'boards', id: string, name: string, columns: Array<{ __typename?: 'columns', id: string, name: string, position: number, cards: Array<{ __typename?: 'cards', id: string, title: string, position: number, column_id: string }> }> } | null };
